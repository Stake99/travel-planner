...
export class ActivityResolver {
  ...
  async getActivityRecommendationsByCoordinates(
    ...
    try {
      ...
      // Get activity rankings using coordinates
      ...
      // Create a city object from coordinates (or provided name)
      const city = new City({
        id: Math.floor(Math.random() * 1000000) + 1000000, // Placeholder ID (non-zero)
